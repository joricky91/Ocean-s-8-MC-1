...
var locationArray: [LocationModel] = [
    ...
    LocationModel(locationName: "Dogo Onsen", street: "5-6 Dogoyunomachi", hours: "Everyday 6AM-11PM", description: "Was build in 1894. It is actually one of the oldest public bathhouse in Japan! Around Dogo Onsen, there are some other bathhouses and also more attractions such as shopping arcade, temples and shrines.", image: "spirited-away-location-1", imageCollection: ["spirited-away-location-1", "spirited-away-location-1.1"], restriction: "Please do not bring food and drinks into Dogo Onsen Honkan, Dogo Onsen Annex Asuka-no-Yu, or Dogo Onsen Tsubaki-no-Yu from the outside.", access: "Dogo Onsen is located in the main tourist hub of Matsuyama and is a five-minute walk from the Dogo tram stop along a bustling shopping arcade. If you are heading to Dogo from JR Matsuyama Station, take the #5 tram. You'll get there in about 30 minutes.", price: "Free (General Admission)", movie: "Spirited Away", bookmark: false, latitude: 33.8520419, longitude: 132.7842178),
    LocationModel(locationName: "Edo Tokyo Tatemono-en", street: "3 Chome-7-1 Sakuracho, Koganei, Tokyo", hours: "Everydat 9:30AM–5:30PM", description: "The Edo-Tokyo Open Air Architectural Museum in Koganei Park, Tokyo, Japan, is a museum of historic Japanese buildings.", image: "spirited-away-location-2", imageCollection: ["spirited-away-location-2", "spirited-away-location-2.1"], access: "From Musashi-Koganai station (JR Chuo line) 5 min from the north exit of Musashi-Koganei station. With the bus from bus stop 2 or 3: Get off at “Koganei-Koen Nishiguchi”. The museum is 5 min walk from there.", price: "200-400 Yen", movie: "Spirited Away", bookmark: false, latitude: 35.7155722, longitude: 139.5103547)
]
