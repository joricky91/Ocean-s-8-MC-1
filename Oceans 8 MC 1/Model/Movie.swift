...
let movieArray: [Movie] = [
    ...
    Movie(id: 4, title: "The Goblin: The Lonely and Great God", releaseDate: "2016-2017", genre: "Drama", synopsis: "Goblin / Kim Shin(Gong Yoo) who seeks to end his cursed immortal life and needs a human bride (Kim Go Eun) to do so.  His life then becomes intertwined with a grim reaper (Lee Dong Wook) who is unable to remember his past. But when the goblin finally finds his bride, he suddenly realizes he wants to live and be with her.", moviePoster: "goblin-poster", city: "Seoul", locationImage: [], locationName: []),
